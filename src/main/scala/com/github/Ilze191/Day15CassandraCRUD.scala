...
object Day15CassandraCRUD extends App {
  ...
  val host = scala.util.Properties.envOrElse("CASSANDRA_HOST","NA")
  val port = scala.util.Properties.envOrElse("CASSANDRA_PORT", "0").toInt
  val username = "avnadmin"
  val password = scala.util.Properties.envOrElse("AIVENPW","no password")
